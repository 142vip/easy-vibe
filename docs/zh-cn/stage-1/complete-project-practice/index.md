---
title: '完整项目实战：从想法到作品'
description: '把已经接入 AI 的原型完整用一遍，请别人来试试，再把发现的问题改好。'
---
...
<div style="margin: 50px 0;">
  <ClientOnly>
    <StepBar :active="0" :items="[
      { title: '自己用一遍', description: '从开始走到结果' },
      { title: '把卡点补好', description: '等待、结果与失败' },
      { title: '请别人来试', description: '先观察，不代操作' },
      { title: '整理并分享', description: '让别人看懂作品' }
    ]" />
  </ClientOnly>
</div>
...
哪怕只找一两个人，也能发现不少明显问题。不用写正式报告，随手记下看到的情况就行：
