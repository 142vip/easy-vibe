---
title: '从截图复刻：第一次模仿练习'
description: '像上课一样，跟着老师把一张产品截图变成可以打开的网页或小游戏。'
---
...
<ChapterIntroduction :duration="duration" :tags="['截图复刻', 'AI 编程', '新手练习']" coreOutput="1 个小项目" expectedOutput="可以打开、可以点击的网页或小游戏">
...
<div style="margin: 50px 0;">
  <ClientOnly>
    <StepBar :active="0" :items="[
      { title: '选截图', description: '找一个喜欢的页面' },
      { title: '丢给 AI', description: '拖进聊天框' },
      { title: '说一句话', description: '让 AI 照着做' },
      { title: '继续改', description: '哪里不像改哪里' }
    ]" />
  </ClientOnly>
</div>
