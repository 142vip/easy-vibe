...
const appendixComponentModules = {
  ...
  './components/appendix/computer-fundamentals/PowerToWebLab.vue': () => import('./components/appendix/computer-fundamentals/PowerToWebLab.vue'),
  './components/appendix/computer-fundamentals/PowerToWebPicture.vue': () => import('./components/appendix/computer-fundamentals/PowerToWebPicture.vue'),
  './components/appendix/computer-fundamentals/PowerToWebFaultFinder.vue': () => import('./components/appendix/computer-fundamentals/PowerToWebFaultFinder.vue'),
...
const appendixComponentRegistrations = [
  ...
  ['PowerToWebLab', './components/appendix/computer-fundamentals/PowerToWebLab.vue'],
  ['PowerToWebPicture', './components/appendix/computer-fundamentals/PowerToWebPicture.vue'],
  ['PowerToWebFaultFinder', './components/appendix/computer-fundamentals/PowerToWebFaultFinder.vue'],
