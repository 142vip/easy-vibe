...
أطلقت Alibaba منصة ModelScope بالتعاون مع لجنة تطوير المصادر المفتوحة في CCF. وإلى جانب أكثر من 200 ألف نموذج مفتوح المصدر و30 ألف مجموعة بيانات، توفر المنصة **Studios** لعرض التطبيقات. يمنحك Studio عنوانًا مجانيًا قابلًا للمشاركة دون أن تتعلم إدارة الخوادم أولًا.
